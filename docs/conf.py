...
from marketplace import __version__ as marketplace_version
...
texinfo_documents = [
    (master_doc, 'marketplace', u'marketplace Documentation',
     author, 'marketplace', 'White dwarf Accretion w/ COSMIC.',
     'Miscellaneous'),
]
